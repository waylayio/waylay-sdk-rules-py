...
**Source:** `waylay.services.rules.models.template_copied`
...
template_copied = TemplateCopied(
    name=...,
    discovery_template=...,
    tags=...,
    variables=...,
...
# Create from JSON
template_copied = TemplateCopied.from_json(
...
template_copied_dict = template_copied.to_dict()
```
