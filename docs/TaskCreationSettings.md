...
**Source:** `waylay.services.rules.models.task_creation_settings`
...
task_creation_settings = TaskCreationSettings(
    name=...,
    resource=...,
    reset_observations=...,
    parallel=...,
...
# Create from JSON
task_creation_settings = TaskCreationSettings.from_json(
    '{ "name": ..., "resource": ..., "resetObservations": ..., "parallel": ..., "gatesNeedFullObservation": ..., "protected": ..., "tags": ..., "variables": ..., "type": ..., "timeZone": ..., "rrule": ..., "cron": ..., "frequency": ..., "start": ... }'
)

# Export to dictionary
task_creation_settings_dict = task_creation_settings.to_dict()
```
