...
**Source:** `waylay.services.rules.models.template_run_invocation`
...
template_run_invocation = TemplateRunInvocation(
    task_id=..., invocation_id=..., sensors=..., actuators=..., log=..., task_output=...
)

# Create from JSON
template_run_invocation = TemplateRunInvocation.from_json(
    '{ "taskId": ..., "invocationId": ..., "sensors": ..., "actuators": ..., "log": ..., "taskOutput": ... }'
)

# Export to dictionary
template_run_invocation_dict = template_run_invocation.to_dict()
```
