...
class BatchQueryStub:
    ...
    def create_json(cls):
        ...
        return batch_query_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "BatchQuery":
        ...
        if json is None:
            ...
            backup_faker = JSF(BatchQueryAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return BatchQueryAdapter.validate_python(
