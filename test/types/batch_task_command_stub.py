...
class BatchTaskCommandStub:
    ...
    def create_json(cls):
        ...
        return batch_task_command_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "BatchTaskCommand":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                BatchTaskCommandAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return BatchTaskCommandAdapter.validate_python(
