...
class StateChangeTriggerStub:
    ...
    def create_json(cls):
        ...
        return state_change_trigger_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "StateChangeTrigger":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                StateChangeTriggerAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return StateChangeTriggerAdapter.validate_python(
