...
class SensorNodeStub:
    ...
    def create_json(cls):
        ...
        return sensor_node_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "SensorNode":
        ...
        if json is None:
            ...
            backup_faker = JSF(SensorNodeAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return SensorNodeAdapter.validate_python(
