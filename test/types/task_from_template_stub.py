...
class TaskFromTemplateStub:
    ...
    def create_json(cls):
        ...
        return task_from_template_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "TaskFromTemplate":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                TaskFromTemplateAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return TaskFromTemplateAdapter.validate_python(
