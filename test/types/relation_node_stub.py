...
class RelationNodeStub:
    ...
    def create_json(cls):
        ...
        return relation_node_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "RelationNode":
        ...
        if json is None:
            ...
            backup_faker = JSF(
                RelationNodeAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return RelationNodeAdapter.validate_python(
