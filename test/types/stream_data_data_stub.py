...
class StreamDataDataStub:
    ...
    def create_json(cls):
        ...
        return stream_data_data_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "StreamDataData":
        ...
        if not json:
            ...
            backup_faker = JSF(
                StreamDataDataAdapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return StreamDataDataAdapter.validate_python(
