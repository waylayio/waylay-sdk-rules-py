...
from ..types.template_copied_stub import TemplateCopiedStub
from ..types.template_created_stub import TemplateCreatedStub
from ..types.template_details_stub import TemplateDetailsStub
from ..types.template_entity_stub import TemplateEntityStub
from ..types.template_listing_stub import TemplateListingStub
from ..types.template_modification_stub import TemplateModificationStub
from ..types.template_plugins_upgraded_stub import TemplatePluginsUpgradedStub
from ..types.template_updated_stub import TemplateUpdatedStub

MODELS_AVAILABLE = (
    find_spec("waylay.services.rules.models") is not None
)
...
def _copy_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str, name: str):
    mock_response = TemplateCopiedStub.create_json()
    httpx_mock_kwargs = {
        "method": "PATCH",
...
async def test_copy(service: RulesService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, TemplateCopied)
...
def _create_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str):
    mock_response = TemplateCreatedStub.create_json()
    httpx_mock_kwargs = {
        "method": "POST",
...
async def test_create(service: RulesService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, TemplateCreated)
...
def _list_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str):
    mock_response = [TemplateListingStub.create_json()]
    httpx_mock_kwargs = {
        "method": "GET",
        "url": re.compile(f"^{gateway_url}/rules/v1/templates(\\?.*)?"),
        "content": json.dumps(mock_response, default=str),
...
async def test_list(service: RulesService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, list[TemplateListing])
...
def _replace_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str, name: str):
    mock_response = TemplateUpdatedStub.create_json()
    httpx_mock_kwargs = {
        "method": "PUT",
        "url": re.compile(f"^{gateway_url}/rules/v1/templates/{name}(\\?.*)?"),
        "content": json.dumps(mock_response, default=str),
...
async def test_replace(service: RulesService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, TemplateUpdated)
...
def _upgrade_plugins_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str):
    mock_response = TemplatePluginsUpgradedStub.create_json()
    httpx_mock_kwargs = {
        "method": "PATCH",
        "url": re.compile(f"^{gateway_url}/rules/v1/templates(\\?.*)?"),
        "content": json.dumps(mock_response, default=str),
...
async def test_upgrade_plugins(
    ...
    check_type(resp, TemplatePluginsUpgraded)
