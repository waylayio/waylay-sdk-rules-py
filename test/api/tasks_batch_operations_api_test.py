...
from ..types.batch_operation_status_stub import BatchOperationStatusStub
...
def _get_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str, batchId: str):
    mock_response = BatchOperationStatusStub.create_json()
    httpx_mock_kwargs = {
        "method": "GET",
...
async def test_get(service: RulesService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, BatchOperationStatus)
