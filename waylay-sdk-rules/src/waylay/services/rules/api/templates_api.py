...
try:
    ...
    if not TYPE_CHECKING:
        ...
        ListQuery = dict
        ListTemplates200ResponseInner = Model
...
class TemplatesApi(WithApiClient):
    ...
    async def copy(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            body_adapter: Any = TypeAdapter(Optional[Dict[str, Any]])
    ...
    async def list(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> List[ListTemplates200ResponseInner] | T | Response | Model:
        """List Templates.
        ...
        response_types_map: Dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": List[ListTemplates200ResponseInner]
                if not select_path
                else Model,
            }
        )
