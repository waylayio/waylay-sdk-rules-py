...
class TasksApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[TaskSpecification, Field(description="Task Specification")]  # fmt: skip  # noqa: UP045
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "201": TaskCreated if not select_path else Model,
            }
        )
    ...
    async def delete(
        ...
        **kwargs,
        ...
        :param query['forceStop'] (dict) <br> query.force_stop (Query) : Force task stop before deletion
        :type query['forceStop']: bool
        :param raw_response: If true, return the http Response object instead of returning an api model object, or throwing an ApiError.
        :param select_path: Denotes the json path applied to the response object before returning it.
                Set it to the empty string `""` to receive the full response object.
        :param response_type: If specified, the response is parsed into an instance of the specified type.
    ...
    async def get(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> TaskWithRuntimeInfo | T | Response | Model:
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": TaskWithRuntimeInfo if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {
            "404": ErrorResponse,
    ...
    async def list(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> builtins.list[TaskWithRuntimeInfo]: ...
    ...
    async def list(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> builtins.list[TaskWithRuntimeInfo] | T | Response | Model:
        ...
        :param query['resourceMetadataExpression'] (dict) <br> query.resource_metadata_expression (Query) : return tasks that has linked resource from a list returned by resource metadata query.
        :type query['resourceMetadataExpression']: str
        ...
        :type query['tags.key']: ListTasksTagsKey
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": list[TaskWithRuntimeInfo] if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {}
        response_types_map.update(non_200_response_types_map)
