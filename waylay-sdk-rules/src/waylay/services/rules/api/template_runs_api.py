...
class TemplateRunsApi(WithApiClient):
    ...
    async def debug_graph(
        ...
        *,
        ...
        query: DebugGraphQuery | QueryParamTypes | None = None,
    ...
    async def debug_graph(
        ...
        *,
        ...
        timeout=STREAM_TIMEOUTS,
        **kwargs,
    ) -> AsyncIterator[TemplateRunInvocation] | AsyncIterator[T] | Response | AsyncIterator[Model]:
        ...
        :type query: DebugGraphQuery | QueryParamTypes, optional
        ...
        :type query['logLevel']: TemplateRunLogLevel
        :param query['nodeToDebug'] (dict) <br> query.node_to_debug (Query) : node to debug inside template or graph (required)
        :type query['nodeToDebug']: str
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[TemplateRunWithGraphSpecification, Field(description="Specification to run template through graph/BN.")]  # fmt: skip  # noqa: UP045
        ...
        if query is not None and MODELS_AVAILABLE and validate_request:
            query = TypeAdapter(DebugGraphQuery).validate_python(query)
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/rules/v1/templates/debug",
    ...
    async def debug(
        ...
        *,
        ...
        query: DebugQuery | QueryParamTypes | None = None,
        raw_response: Literal[False] = False,
        select_path: Literal[""] = "",
        response_type: Literal[None] = None,
        validate_request: StrictBool = True,
    ...
    async def debug(
        ...
        **kwargs,
        ...
        :param query: URL Query parameters.
        :type query: DebugQuery | QueryParamTypes, optional
        :param query['logLevel'] (dict) <br> query.log_level (Query) : sets the log level for filtering out logs to requested log level or higher from the template run output. Value `NONE` will disable all logs. If not specified all logs will be returned.
        :type query['logLevel']: TemplateRunLogLevel
        :param query['nodeToDebug'] (dict) <br> query.node_to_debug (Query) : node to debug inside template or graph (required)
        :type query['nodeToDebug']: str
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Annotated[TemplateRunSpecification, Field(description="Specification to run template")]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
        ...
        # query parameters
        if query is not None and MODELS_AVAILABLE and validate_request:
            query = TypeAdapter(DebugQuery).validate_python(query)
        ...
        return await self.api_client.request(
            method="POST",
            resource_path="/rules/v1/templates/{name}/debug",
            path_params=path_params,
            params=query,
            **body_args,
            headers=headers,
