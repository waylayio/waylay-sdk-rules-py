...
class TasksBatchOperationsApi(WithApiClient):
    ...
    async def get(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> BatchOperationStatus | T | Response | Model:
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": BatchOperationStatus if not select_path else Model,
            }
        )
    ...
    async def start(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[BatchTaskSpec, Field(description="Tasks Batch Operation")]  # fmt: skip  # noqa: UP045
